...
//Make sure the camera is plugged into pins 5 and 6 for Rx/Tx
...
int JPEGCamera::readData(char * response, int address)
{
	...
	cameraPort.write((byte)(address>>8));
	cameraPort.write((byte)address);
	cameraPort.write((byte)0x00);
	cameraPort.write((byte)0x00);
	cameraPort.write((byte)(read_size>>8));
	cameraPort.write((byte)(read_size));
	cameraPort.write((byte)0x00);
	...
	Serial.write((byte)(address>>8));
	Serial.write((byte)(address));
	Serial.write((byte)(0x00));
	Serial.write((byte)(0x00));
	Serial.write((byte)(read_size>>8));
	Serial.write((byte)(read_size));
	Serial.write((byte)(0x00));
